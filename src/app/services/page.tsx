            ...
            {services.map((service, i) => {
              ...
              return (
                <ScrollReveal key={service.id} delay={i * 0.05}>
                  <div
                    id={service.id}
                    className="group p-8 rounded-2xl border border-gray-200 bg-white hover:border-brand-accent/30 hover:shadow-md hover:shadow-brand-accent/8 transition-all"
                  >
