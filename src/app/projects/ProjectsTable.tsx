        ...
        <AnimatePresence mode="popLayout">
          {filtered.map((p, i) => (
            <motion.div
              ...
              className="group flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5 px-6 py-5 rounded-2xl border border-gray-200 bg-white hover:bg-brand-darker hover:border-brand-accent/30 transition-all"
            >
              {/* 연도 */}
