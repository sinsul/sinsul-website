            ...
            <div className="space-y-4">
              {news.map((item, i) => (
                <ScrollReveal key={item.id} delay={i * 0.08}>
                  ...
                  <article className="group p-6 rounded-2xl border border-gray-200 bg-white hover:border-brand-accent/30 hover:bg-brand-darker transition-all cursor-pointer">
